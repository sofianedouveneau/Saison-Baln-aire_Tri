...
Sans utiliser la phase de peuplement via les tables temporaires, il m’aurait été impossible de remplir les tables définitives à cause d’une incompatibilité entre ces dernières et les fichiers .csv.
